  ...
  return (
    <main className="mx-auto max-w-md px-4 py-16">
      <GlassCard className="p-8">
        ...
        <p className="text-white/70 mt-1 text-center">Sign in to continue</p>
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          <div>
            <label className="block text-sm mb-2 text-white/80">Email</label>
            <input className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/60
          ...
          <p className="text-center text-sm text-white/70 mt-6">
            ...
            <a href="/signup" className="text-brand-300 hover:text-brand-200 font-medium">
              Sign up
            </a>
          </p>
        </form>
